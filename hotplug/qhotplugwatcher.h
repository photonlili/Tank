...
class QHotplugConsoleWatcher : public QThread
{
	Q_OBJECT
public:
    static QHotplugConsoleWatcher *Instance();
...
private:
    ...
    explicit QHotplugConsoleWatcher(QObject *parent = 0);
    static QHotplugConsoleWatcher* _instance;
    quint32 m_devType;
    quint32 m_devStat;
    QString m_storage;
    QTimer* timer;
