...
QHotplugConsoleWatcher* QHotplugConsoleWatcher::_instance = NULL;
QHotplugConsoleWatcher::QHotplugConsoleWatcher(QObject *parent) :
    QThread(parent)
{
    m_devType = E_NULLDEV;
...
QHotplugConsoleWatcher *QHotplugConsoleWatcher::Instance()
{
    if(_instance)
        return _instance;
    _instance = new QHotplugConsoleWatcher();
    return _instance;
}

void QHotplugConsoleWatcher::slotDeviceAdded(const QString &dev)
{
...
void QHotplugConsoleWatcher::slotDeviceDriver()
{
...
bool QHotplugConsoleWatcher::event(QEvent *e) {
