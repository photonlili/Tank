#include "qpreviewui.h"
#include "ui_qpreviewui.h"

QPreviewUI::QPreviewUI(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::QPreviewUI)
{
    ui->setupUi(this);
...
int QPreviewUI::convert_yuv_to_rgb_pixel(int y, int u, int v)
{
...
int QPreviewUI::convert_yuv_to_rgb_buffer(unsigned char *yuv, unsigned char *rgb, unsigned int width, unsigned int height)
{
...
void QPreviewUI::paintEvent(QPaintEvent *)
{
    if(fd <= 0)
        return;
...
void QPreviewUI::mousePressEvent(QMouseEvent *e)
{
